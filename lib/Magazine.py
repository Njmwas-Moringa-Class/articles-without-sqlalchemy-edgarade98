class Magazine:
    ...
    def article_titles(cls, magazine_name):
        ...
        if magazine:
            return [article.title for article in magazine.written_articles]
        else:
            return []

    def contributing_authors(self):
        authors_count = {}
        for article in self.wriiten_articles:
    ...
    def contributors(self):
        return list(set(article.author for article in self.wriiten_articles))
